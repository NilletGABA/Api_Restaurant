package com.gamboa.api_restaurant.config;
...
public class OpenAPIConfig {
  ...
  @Value("${gamboa.openapi.dev-url}")
  private String devUrl;

  @Value("${gamboa.openapi.prod-url}")
  ...
  public OpenAPI myOpenAPI() {
    ...
    contact.setEmail("gamboa@gmail.com");
    contact.setName("nillet");
